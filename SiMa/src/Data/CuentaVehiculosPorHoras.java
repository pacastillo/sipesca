 ...
 * @author mgarenas
 */
public class CuentaVehiculosPorHoras {
    ...
    public CuentaVehiculosPorHoras(String lFileName) throws IOException {
        fileName = lFileName;
        createFile();
        openFile();
        writeHead();
    ...
    public CuentaVehiculosPorHoras() throws IOException {
    ...
    public void writeHead() throws IOException {
        bw.write("Nodo\tnombre\tDispositivos\tRangoHorario\n");
    }
    ...
    public void calcular(Conectar cn) throws SQLException, IOException {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            while (rs.next()) {
                ...
                st2 = cn.crearSt();
                s = "select paso.idNodo, nodo.nombre, count(idDispositivo) as numero, HOUR(FROM_UNIXTIME(tInicio/1000))"+
