 ...
 * @author mgarenas
 */
public class SumaTiemposDeDispositivoEnNodo {
    String         fileName;
    File           f;
    FileWriter     fw;
    BufferedWriter bw;

    public SumaTiemposDeDispositivoEnNodo(String lFileName) throws IOException {
        fileName = lFileName;
        createFile();
        openFile();
        writeHead();
    ...
    public SumaTiemposDeDispositivoEnNodo() throws IOException {
        fileName = "SumaTiemposDeDispositivoEnNodo.txt";
        createFile();
        openFile();
        writeHead();
    }
private void createFile() {
    ...
    public void writeHead() throws IOException {
        bw.write("Dispositivo\tidNodo\tSumaTiempos\tNombreNodo\n");
    }
    ...
    public void calcular(Conectar cn) throws SQLException, IOException {
        ...
        ResultSet rs = st1.executeQuery("select paso.idDispositivo, paso.idNodo, sum(tFin-tInicio), nodo.nombre from paso, nodo where paso.idNodo=nodo.idNodo group by paso.idDispositivo,paso.idNodo;");
        String s;
        while (rs.next()) {
